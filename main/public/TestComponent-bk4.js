...
/***/ function(module, exports, __webpack_require__) {
	...
	var _checkboxMixin = __webpack_require__(164);
	
	var _checkboxMixin2 = _interopRequireDefault(_checkboxMixin);
	...
	var Test = function (_Component) {
	  ...
	  _createClass(Test, [{
	    ...
	    value: function _onTestCheckboxChange(valueObj) {
	      console.log("Test: _onTestCheckboxChange:", valueObj);
	      this.setState({
	        testCheckboxChecked: valueObj.checked,
	        testCheckboxValue: valueObj.value
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2.default.createElement(_checkboxMixin2.default, {
	        id: 1234,
	        hide: this.state.hide,
	        isChecked: this.state.testCheckboxChecked,
	        trueValue: 'YES',
	        falseValue: 'NO',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixins = __webpack_require__(160);
	  ...
	  _createClass(Checkbox, [{
	    ...
	    value: function _onChange(e) {
	      if (this.props.onChangeValue) this.props.onChangeValue({
	        ...
	        value: e.target.checked ? this.props.trueValue : this.props.falseValue
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var other = _objectWithoutProperties(_props, ['style', 'isChecked', 'onChangeValue']);
	...
	Checkbox.propTypes = _.assignIn({}, _mixins2.default.inputPropTypes, {
	  ...
	  trueValue: _react.PropTypes.node,
	  falseValue: _react.PropTypes.node
	});
...
/***/ }
/******/ ]);
//# sourceMappingURL=TestComponent-bk4.js.map